export function Logo({ className = 'h-8 w-8' }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id='flame-grad-user' x1='0%' y1='0%' x2='0%' y2='100%'>
          <stop offset='0%' stopColor='#FF6B35' stopOpacity={1} />
          <stop offset='50%' stopColor='#F7931E' stopOpacity={1} />
          <stop offset='100%' stopColor='#FDC830' stopOpacity={1} />
        </linearGradient>
        <linearGradient id='hammer-grad-user' x1='0%' y1='0%' x2='0%' y2='100%'>
